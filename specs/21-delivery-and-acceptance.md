...
|---|---|---|
| **0. Foundations** | Repo, CI, single-process skeleton — monorepo, Java 21 + Spring Boot 3.4 (fat jar), sqlite-jdbc SQLite (WAL), React+Vite console shell (TS strict), REST+WS, 3-OS CI matrix, OCI images under rootless Podman + kind-on-Podman Kubernetes CI (CFG-030) | 1 wk |

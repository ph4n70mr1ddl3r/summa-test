...
- **DRP-022** — A goal with no live initiative — org-wide or domain-scoped alike — whose
  window ends routes the same ask to its owner — the admin when the owner is an agent or
  departed. No goal expires silently.
